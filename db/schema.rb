...
ActiveRecord::Schema.define(version: 20140412140037) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "manndi_users", force: true do |t|
  ...
  add_index "manndi_users", ["email"], name: "index_manndi_users_on_email", unique: true, using: :btree
  add_index "manndi_users", ["reset_password_token"], name: "index_manndi_users_on_reset_password_token", unique: true, using: :btree
